...
// If you have a logo SVG, you can import it, e.g.:
        ...
        <>
            <header className="header">
                <div className="logo-container">
                    {/* If you have an SVG logo, replace the text with: <img src={LogoSVG} alt="MyBank logo" /> */}
                ...
                <section className="hero-section">
                    ...
                    <div className="hero-right">
                        <img
                            ...
                            loading="lazy"
                            // consider adding srcSet/picture for responsive images
                        />
                    </div>
                </section>
            </main>

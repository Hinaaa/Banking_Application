...
// fetch balance:
    ...
    const handleTransferMoney = async () => {
        ...
        //axios
        try {
            const newTransaction = await TransactionMoney(payload); // Call API after building payload
    ...
    return (
        ...
        <div className="add-amount">
            ...
            <h2>Transfer Money to your Account</h2>
            ...
            <div className="amount-form">
                ...
                <div className="radio-group"> {/* Added class for styling */}
                    <label htmlFor="bank-transfer-radio">
                        ...
                        />
                        <span>Transfer via Bank Transfer</span>
                    </label>
                    <label htmlFor="card-transfer-radio">
                        ...
                        />
                        <span>Transfer via Card Details</span>
                    </label>
                </div>

                {selectTransactionType === "bankTransfer" && (
                    <div className="add-money-transaction-by-iban">
                        <h3>IBAN Details of Account to Which You want to Transfer Money to Your Account</h3>
                        <input
                            type="text"
                ...
                {selectTransactionType === "cardTransfer" && (
                    <div className="add-money-transaction-by-card">
                        <h3>Card Details to Which You Want to Transfer Money</h3>
                        <input
                            type="text"

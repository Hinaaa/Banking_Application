        ...
        <>
            ...
            <form onSubmit={handleAccountRegister}>
                <div className="iban-block">
                    ...
                    <input
                        type = "text" placeholder ="Account Holder Name * " value = {accountHolderName}
                        onChange={(e) => setAccountHolderName(e.target.value)}
                    />
                    <label htmlFor="iban">IBAN: </label>
                    <input
                        type = "text" placeholder ="IBAN * " value = {iban}
                        onChange={(e) => setIban(e.target.value)}
                    />
                    <label htmlFor="bic">BIC: </label>
                    <input
                        type = "text" placeholder ="BIC (Bank Identifier Code)" value = {bic}
                ...
                <div>
                    ...
                    <input
                        type="text" placeholder="Card Holder Name *" value={cardHolder}
                    ...
                    <input
                        type="password" placeholder="CVV *" value={cvv}
                        onChange={(e) => setCvv(e.target.value)}
                    />
                </div>
                <div>Registration PIN </div>
                <label htmlFor="pin">CVV:</label>
                <input
                    type="text" placeholder="Registration PIN *" value={pin}
                    onChange={(e) => setPin(e.target.value)}
                />
                <button type="submit">
                    Register Account and Proceed
                </button>
                {responseMessage && (
